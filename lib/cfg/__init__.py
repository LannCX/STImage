...
class BaseConfig(object):
    def __init__(self, args=None):
        ...
        _C.DATASET.VERSION = ''
        _C.DATASET.SCALE_SIZE = (256, 320)  # width * height
        ...
        _C.TRAIN.LR_SCHEDULER = 'multistep'  # [multistep, cosine, plateau] for now
        ...
        _C.TRAIN.DROP_LAST = True  # prevent batch size can not be divided by #GPU
